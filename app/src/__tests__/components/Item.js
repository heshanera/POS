...
describe('Item component', () => {
  ...
  it('should ask the messege to delete the item from the alert', () => {
    ...
    wrapper.find('.delete-item').simulate('click');
    expect(
      wrapper.find('#alert-dialog-description').containsMatchingElement(
        <span>
          Are you sure want to remove <b>itemX</b> from the order?
        </span>,
      ),
    ).toBeTruthy();
  });
  ...
  it('should ask the messege to delete the order if the last item of the order is deleted', () => {
    ...
    expect(
      wrapper.find('#alert-dialog-description').containsMatchingElement(
        <span>
          Are you sure want to remove <b>itemX</b> from the order? Removing this will delete this order!
        </span>,
      ),
    ).toBeTruthy();
  });
