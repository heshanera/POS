...
describe('Order reducer', () => {
  ...
  it('should handle REQUEST_ORDERS', () => {
    ...
    expect(reducer(orders, { type: orderActions.REQUEST_ORDERS })).toEqual({
  ...
  it('should handle RECEIVE_ORDERS', () => {
    ...
    expect(reducer([], { type: orderActions.RECEIVE_ORDERS, payload: orders })).toEqual({
      orderList: orders.orderList,
      loading: false,
    });
    expect(reducer(orders, { type: orderActions.RECEIVE_ORDERS, payload: newOrders })).toEqual({
      orderList: newOrders.orderList,
      loading: false,
    });
  });
  ...
  it('should handle UPDATE_ORDERS', () => {
    ...
    expect(reducer([], { type: orderActions.UPDATE_ORDERS, payload: orders })).toEqual({
      orderList: orders.orderList,
      loading: false,
    });
    expect(reducer(orders, { type: orderActions.UPDATE_ORDERS, payload: newOrders })).toEqual({
      orderList: newOrders.orderList,
      loading: false,
    });
  });
